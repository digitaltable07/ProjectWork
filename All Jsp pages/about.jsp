		...
		<section class="ftco-section ftco-wrap-about ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 text-center">
	            ...
	            <h2 class="mb-4">DTS Restaurant</h2>
	          </div>
						<p>Digital Table Service is the web application that will provide them all this facility. Customer can track his/her order and after ordering food in mean time they can play game, listen music etc.They can  payment through this  application has two options either customer can pay by cash or if customer wants to pay through online then they can pay through default payment gateway.</p>
